...
bool message_info__msg__slave__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // sw1
    ...
    assert(PyLong_Check(field));
    ros_message->sw1 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // sw2
    ...
    assert(PyLong_Check(field));
    ros_message->sw2 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // sw3
    ...
    assert(PyLong_Check(field));
    ros_message->sw3 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * message_info__msg__slave__convert_to_py(void * raw_ros_message)
{
  ...
  {  // sw1
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->sw1);
    {
  ...
  {  // sw2
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->sw2);
    {
  ...
  {  // sw3
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->sw3);
    {
